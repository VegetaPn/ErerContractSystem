     ...
     <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">待签订合同列表</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="dataTable_wrapper">
                        ...
                        <td class="center">
                        <button type="button" class="btn btn-info" onclick="window.location.href='SignServlet?content=<%=((Contract)contracts.get(i)).getContent()%>&time=<%=((Contract)contracts.get(i)).getBeignTime()%>&type=detail&id=<%=((Contract)contracts.get(i)).getId()%>&conname=<%=((Contract)contracts.get(i)).getName()%>'" id="allocate<%=i %>">签订</button> 
