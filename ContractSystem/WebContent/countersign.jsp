...
<head>
   ...
   <link href="bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css" rel="stylesheet">
    ...
    <![endif]-->
     <%
	    ArrayList<Contract> contracts=(ArrayList<Contract>)request.getAttribute("hqcon");
     ...
     <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">待会签合同列表</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="dataTable_wrapper">
                        ...
                        <td><span style="color: rgb(255,0,0)"> 待会签</span></td>
                        <td><%=((Contract)contracts.get(i)).getCustomer()%></td>
                        <td><%=((Contract)contracts.get(i)).getBeignTime()%></td>
                        <td class="center">
                        <button type="button" class="btn btn-info" onclick="window.location.href='CounterSignServlet?time=<%=((Contract)contracts.get(i)).getBeignTime()%>&type=detail&id=<%=((Contract)contracts.get(i)).getId()%>&conname=<%=((Contract)contracts.get(i)).getName()%>'" id="allocate<%=i %>">会签</button> 
