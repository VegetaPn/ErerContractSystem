            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="pages/UserProfile.jsp"><i class="fa fa-user fa-fw"></i> <%=name1 %></a>
                        </li>
     ...
     <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">待分配合同列表</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="dataTable_wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                                    <thead>
                                        ...
                                        <th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 170px;">
                                                                                                                                               合同名称</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 207px;">起草人</th>
                        ...
                        <td class="center"><%=(String)names.get(i)%></td>
                        <td><%=((Contract)contracts.get(i)).getCustomer()%></td>
                        <td><%=((Contract)contracts.get(i)).getBeignTime()%></td>
                        <td class="center">
                        <button type="button" class="btn btn-info" onclick="window.location.href='AllocateServlet?type=detail&id=<%=((Contract)contracts.get(i)).getId()%>&conname=<%=((Contract)contracts.get(i)).getName()%>'" id="allocate<%=i %>">分配</button> 
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <h4>起草人</h4><p><%=(String)names.get(i)%></p>
