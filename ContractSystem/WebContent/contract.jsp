        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">欢迎进入合同管理系统</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><%=ContractDao.getHqNum(userid) %></div>
                                    <div>待会签合同</div>
                                </div>
                            </div>
                        </div>
                        <a href="CounterSignServlet?type=before">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><%=ContractDao.getDgNum(userid) %></div>
                                    <div>待定稿合同</div>
                                </div>
                            </div>
                        </div>
                        <a href="FinalizedServlet?type=before">
                            <div class="panel-footer">
                                <span class="pull-left">查看详情</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><%=ContractDao.getSpNum(userid) %></div>
                                    <div>待审批合同</div>
                                </div>
                            </div>
                        </div>
                        <a href="ApproveServlet?type=before">
                            <div class="panel-footer">
                                <span class="pull-left">查看详情</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><%=ContractDao.getQdNum(userid) %></div>
                                    <div>待签订合同</div>
                                </div>
                            </div>
                        </div>
                        <a href="SignServlet?type=before">
                            <div class="panel-footer">
                                <span class="pull-left">查看详情</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
