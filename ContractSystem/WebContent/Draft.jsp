...
<%@page import = "dao.LogDao"%>
        <%String apath = this.getServletContext().getRealPath("");
          ...
          LogDao.addaLog("Draft a contract:", apath, uname);
        %>
</head>
        ...
        <div id="page-wrapper">
            ...
            <form role="form" action="DraftServlet"  method="post"  enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">必须填写合同名称</p>
                                        </div>
                                        <div class="form-group">
                                            <label>客户：</label>
                                            <input class="form-control" placeholder="Enter text" id="CunName" name="CunName">
                                        </div>
                                         <div class="form-group">
                                            <label>起始时间</label>
                                            <input class="form-control" placeholder="Enter text" id="BTime" name="BTime">
                                            <p class="help-block">必须按 “yyyy-mm-dd”格式填写</p>
                                        </div>
                                         <div class="form-group">
                                            <label>终止时间</label>
                                            <input class="form-control" placeholder="Enter text" id="ETime" name="ETime">
                                             <p class="help-block">必须按 “yyyy-mm-dd”格式填写</p>
                                        </div>
                                         <div class="form-group">
                                            <label>合同内容</label>
                                            <textarea class="form-control" rows="5" id="text1" name="text1"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>上传附件</label>
