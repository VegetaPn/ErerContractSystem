...
<body>
    ...
    <div id="wrapper">
        ...
        <%String apath = this.getServletContext().getRealPath("");
          ...
          LogDao.addaLog("Enter Customer-Manage page", apath, uname);
        %>
        <%CustomerService cs = new CustomerService();
          UserService us = new UserService(); %>
        <%Customer[] customers = cs.getallCustomers(); %>
	            ...
	            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
	                ...
	                <tbody>
	                	<%for (int i = 0; i < customers.length; i++) {
	                		out.print("<tr>");
                			out.print("    <td>"+us.getName(customers[i].getNum())+"</td>");
                			out.print("    <td>"+customers[i].getName()+"</td>");
                			out.print("    <td>"+customers[i].getAdress()+"</td>");
                			out.print("    <td>"+customers[i].getTel()+"</td>");
                			out.print("    <td>"+customers[i].getFax()+"</td>");
                			out.print("    <td>"+customers[i].getCode()+"</td>");
                			out.print("    <td>"+customers[i].getBank()+"</td>");
                			out.print("    <td>"+customers[i].getAccount()+"</td>");
                			out.print("	   <td>"+ "<a href='CustomerSettings.jsp?"+
                								"uname="+us.getName(customers[i].getNum())+
                								"&cname="+customers[i].getName()+
                								"&cadd="+customers[i].getAdress()+
                								"&ctel="+customers[i].getTel()+
                								"&cfax="+customers[i].getFax()+
                								"&ccode="+customers[i].getCode()+
                								"&cbank="+customers[i].getBank()+
                								"&ccct="+customers[i].getAccount()+
                								"'>设置</a>" +"</td>");
                			out.print("</tr>");
	                	} %>
	                </tbody>
