    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <%UserService us = new UserService();
                                      ...
                                      while(ars.next()) {
                                    	  ...
                                    	  for(int i = 1; i < col; i++) {
                                    		  if (i == 4) {
                                    			  out.print("<td>"+rs.getFuncNamebyFuncNumString(ars.getString(i))+"</td>");
                                    		  } else {
                                    			  out.print("<td>"+ars.getString(i)+"</td>"); 
                                    		  }
                                    	  }
                                    	  out.print("<td>"+"<a href='RoleSettings.jsp?paramname="+ars.getString(2)+"&paramdesc="+ars.getString(3)+"&paramid="+ars.getString(1)+"'>设置</a>"+"</td>");
                                    	  out.print("</tr>");
                                      }
                                      %>
                            ...
                            <br />
                            <button type='button' class='btn btn-default' onclick="window.location.href='AddRole.jsp'">添加角色</button>
                            <!-- /.table-responsive -->
                        </div>
                        </form>
            	</div>
