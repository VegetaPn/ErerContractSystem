	            ...
	            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
	                ...
	                <tbody>
	                	<%for (int i = 0; i < contracts.length; i++) {
	                		out.print("<tr>");
                			out.print("    <td>"+contracts[i].getId()+"</td>");
                			out.print("    <td>"+contracts[i].getName()+"</td>");
                			out.print("    <td>"+contracts[i].getCustomer()+"</td>");
                			out.print("    <td>"+cs.getContractStatebyConid(contracts[i].getId())+"</td>");
                			out.print("	   <td>"+"<button  class='btn btn-info' data-toggle='modal' data-target='#myModal"+i+"'  >详情</button>"+
                								"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+
                								"<a href='ContractDelete.jsp?"+
                								"cid="+contracts[i].getId()+
                								"'>删除</a>" +"</td>");
                			out.print("</tr>");
	                	 
	                	
	                    out.print("<div class='modal fade' id='myModal"+i+"' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>");
	                    out.print("            <div class='modal-dialog'>" + 
	                                    "<div class='modal-content'>" +
	                                        ...
	                                        "<div class='modal-body'>" +
	                                            "<h4>合同编号：</h4><p>"+contracts[i].getId()+"</p>" +
	                                            "<h4>客户：</h4><p>"+contracts[i].getCustomer()+"</p>"+
	                                            "<h4>开始时间：</h4><p>"+contracts[i].getBeignTime()+"</p>"+
	                                            "<h4>结束时间：</h4><p>"+contracts[i].getEndTime()+"</p>"+
	                                            "<h4>合同内容：</h4><p>"+contracts[i].getContent()+"</p>"+
	                                        "</div>"+
