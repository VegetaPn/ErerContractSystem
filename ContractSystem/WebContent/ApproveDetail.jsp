   ...
   <%int userid = (int)session.getAttribute("userid"); %>
     ...
     <!-- Page Content -->
        <div id="page-wrapper">
            ...
            <form role="form" action="ApproveServlet?id=<%=conid %>&type=approve"  method="post"  >
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea readonly="readonly" class="form-control" rows="5" id="text1" name="text1" ><%= content %></textarea>
                                        </div> 
                                            <div class="form-group">
                                            <label class="radio-inline">
                                                <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline1" value="agree" checked>通过
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline2" value="reject">拒绝
                                            </label>
                                        </div>
                                         <div class="form-group">
                                            <textarea class="form-control" rows="5" name="text2" placeholder="输入审批意见"></textarea>
