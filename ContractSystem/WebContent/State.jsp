...
<head>
 ...
 <link href="dist/css/timeline.css" rel="stylesheet">
   ...
   <link href="bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css" rel="stylesheet">
    ...
    <![endif]-->
     <%
	    ArrayList<Contract> contracts=(ArrayList<Contract>)request.getAttribute("spcon");
     ...
     <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">我的合同状态</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="dataTable_wrapper">
                        ...
                        <%} %>
                        <%if (state.get(i)==2) {%>
                        <td><span style="color: rgb(255,0,0)"> 等待会签</span></td>
                        <%} %>
                         <%if (state.get(i)==3) {%>
                        <td><span style="color: rgb(0,255,0)"> 等待定稿</span></td>
                        <%} %>
                         <%if (state.get(i)==4) {%>
                        <td><span style="color: rgb(0,0,255)"> 等待审批</span></td>
                        <%} %>
                        <%if (state.get(i)==5) {%>
                        <td><span style="color: rgb(0,255,255)"> 等待签订</span></td>
                        <%} %>
                         <%if (state.get(i)==6) {%>
                        ...
                        <td class="center">
                       <button  class="btn btn-info" data-toggle="modal" data-target="#myModa<%=i %>"  >流程</button>
                    ...
                    <!-- 对话框里的内容 -->
                     <div class="modal fade" id="myModa<%=i %>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel">合同流程</h4>
                                        </div>
                                  ...
                                  <li>
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">起草合同</h4>
                                           
                                        </div>
                                        <div class="timeline-body">
                                            <p>时间：<%=((Contract)contracts.get(i)).getBeignTime()%></p>
                                        </div>
                                    </div>
                                </li>
                                <%if(state.get(i)>=2) {%>
                                <li class="timeline-inverted">
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">分配合同</h4>
                                        </div>
                                        <div class="timeline-body">
                                        <%ArrayList<String> list1=ContractDao.getHqUser(((Contract)contracts.get(i)).getId()); %>
                                        <%ArrayList<String> list2=ContractDao.getSpUser(((Contract)contracts.get(i)).getId()); %>
                                        <%ArrayList<String> list3=ContractDao.getQdUser(((Contract)contracts.get(i)).getId()); %>
                                            <p>管理员已分配此合同的会签人：</p>
                                         <%for(int a=0;a<list1.size();a++){ %>  <p> <%=list1.get(a) %></p><%} %>
                                ...
                                <li>
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">合同已会签</h4>
                                        </div>
                                        <div class="timeline-body">
                                            <p>会签人均已完成会签</p>
                                        </div>
                               ...
                               <li class="timeline-inverted">
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">合同已经定稿</h4>
                                        </div>
                                        <div class="timeline-body">
                                ...
                                <li>
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">合同已经审批</h4>
                                        </div>
                                        <div class="timeline-body">
                                            <p>合同已经进行了审批</p>
                                ...
                                <%if(state.get(i)>=6){%>
                                   <li class="timeline-inverted">
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">合同已经签订完成</h4>
                                        </div>
                                        <div class="timeline-body">
                                            <p>所有签订人已经完成签订</p>
                                        </div>
